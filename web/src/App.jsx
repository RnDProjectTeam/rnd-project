...
function App() {
  ...
  if (initializing) {
    return (
      <Box sx={{ display: "flex", height: "100vh", width: "100vw", flexDirection: "column", alignItems: "center", justifyContent: "center", bgcolor: "#FAFCFE", gap: 2 }}>
...
function InvalidDomainPage() {
  const navigate = useNavigate();
  return (
    <Box sx={{ display: "flex", height: "100vh", width: "100vw", flexDirection: "column", alignItems: "center", justifyContent: "center", bgcolor: "#F1F5F9", px: 2 }}>
      <Card sx={{ width: "100%", maxWidth: 448, p: 4, textAlign: "center", borderRadius: "16px" }}>
        <Box sx={{ mx: "auto", display: "flex", alignItems: "center", justifyContent: "center", width: 48, height: 48, borderRadius: "50%", bgcolor: "#fee2e2", color: "#b91c1c", mb: 2 }}>
        ...
        <Typography variant="h6" sx={{ fontWeight: 600 }}>Invalid Email Domain</Typography>
        ...
        <Button
          ...
          sx={{ mt: 3, bgcolor: "#0077B6", "&:hover": { bgcolor: "#005B96" }, borderRadius: "12px", textTransform: "none", fontWeight: 500 }}
        >
          Back to Login
        </Button>
      </Card>
