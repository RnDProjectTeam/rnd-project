...
const FacultyRoute = ({
  ...
  if (role !== "faculty" && role !== "admin") return <Navigate to="/error" replace />;

  const navTabs = [
    { label: "Dashboard", active: isListPage, onClick: () => navigate("/dashboard") },
                ...
                {profileMenuOpen && (
                  ...
                  >
                    ...
                    <List dense sx={{ py: 0.5 }}>
                      ...
                      <ListItemButton
                        onClick={() => { setProfileMenuOpen(false); navigate("/profile?section=directory"); }}
                        sx={{ borderRadius: "10px", mx: 0.5, "&:hover": { bgcolor: "#EFF6FF", color: "#0077B6" } }}
                      >
