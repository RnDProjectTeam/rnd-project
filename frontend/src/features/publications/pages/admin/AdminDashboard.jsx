...
export default function AdminDashboard({ entries, users }) {
  ...
  const approvedCount = entries.filter(
    (e) => e.status === "approved_for_publication",
  ).length;
  ...
  console.log("/publications-tracker/" + quickLinks[0].to);
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, xl: 8 }}>
          ...
          >
            ...
            <Typography
              variant="h4"
              sx={{ mt: 2, fontWeight: 600, color: "#1F2933" }}
            >
              Admin dashboard
            </Typography>
            <Typography
              variant="body2"
              sx={{ mt: 2, lineHeight: 1.7, color: "#4B5563" }}
            >
              ...
              {quickLinks.map((link) => (
                <Grid size={{ xs: 12, sm: 6 }} key={link.to}>
                  ...
                  >
                    ...
                    <Typography
                      variant="h6"
                      sx={{ mt: 1.5, fontWeight: 600, color: "#1F2933" }}
                    >
                      {link.stat}
                    </Typography>
                    <Typography
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                ...
                >
                  ...
                  <Typography variant="body2" sx={{ mt: 1, color: "#4B5563" }}>
                    Admins can approve entries, request revisions, and publish
                    work for everyone.
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{ mt: 1.5, color: "#4B5563" }}
                  >
                    Approved {approvedCount} entries · Published{" "}
                    {publishedCount} entries.
                  </Typography>
                </Box>
              </Grid>
            </Grid>
        ...
        <Grid size={{ xs: 12, xl: 4 }}>
          ...
          >
            ...
            <List
              dense
              sx={{ mt: 3, "& .MuiListItem-root": { px: 0, py: 0.5 } }}
            >
              {[
            ...
            >
              ...
              >
                Admins are the only role with access to the full review
                workflow. The rest of the app is built around faculty
                submissions and review requests.
              </Typography>
            </Box>
          </Card>
        </Grid>
