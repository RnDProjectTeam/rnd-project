...
const DashboardDetailView = ({
  ...
  const openProfile = (identifier) =>
    navigate(
      `/publications-tracker/profile?search=${encodeURIComponent(identifier)}&view=${encodeURIComponent(identifier)}&section=directory`,
    );

  const statusSx = (statusKey) =>
    STATUS_SX[statusClasses[statusKey]] ?? {
      bgcolor: "#F1F5F9",
      color: "#1F2933",
    };
  ...
  async function handleStatusChange(nextStatus, kind, note) {
    ...
    try {
      const response = await fetch(
        `/api/keshava/publications/${selectedEntryId}/status`,
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      setEntries((current) =>
        current.map((e) => (e.id === selectedEntryId ? result.item : e)),
      );
    ...
    >
      ...
      >
          ...
          >
            {!sidebarCollapsed && (
              <Box>
                ...
                <Typography
                  variant="subtitle1"
                  sx={{ mt: 0.25, fontWeight: 600, color: "white" }}
                >
                  Entries
                </Typography>
              </Box>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Chip
                    label={`${sidebarFiltered.length} shown`}
                    size="small"
                    sx={{
                      ml: "auto",
                      height: 16,
                    ...
                    return (
                      <Chip
                        ...
                        sx={{
                          ...
                          boxShadow: isActive
                            ? "0 1px 4px rgba(11,45,77,0.18)"
                            : "none",
                          "&:hover": {
                            bgcolor: isActive ? "#005B96" : "#E2E8F0",
                            borderColor: isActive ? "#005B96" : "#94A3B8",
                          },
                        }}
                      />
                    );
        ...
        <Box sx={{ flex: 1, p: { xs: 1.5, sm: 2 }, minWidth: 0 }}>
          <Box
            component="section"
            sx={{ mx: "auto", maxWidth: 1280, position: "relative" }}
          >
            {/* Admin return FAB */}
            ...
            >
              ...
              >
                <Box>
                  ...
                  <Typography
                    variant="h5"
                    sx={{ mt: 1, fontWeight: 600, color: "#0B2D4D" }}
                  >
                    Entry details
                  </Typography>
                </Box>
                <Button
                  ...
                  sx={{
                    borderColor: "#D9E2EC",
                    color: "#1F2933",
                    "&:hover": { bgcolor: "#F1F5F9", borderColor: "#93C5FD" },
                    borderRadius: "20px",
                    textTransform: "none",
                    fontWeight: 600,
                    boxShadow: 1,
                  ...
                  >
                    ...
                    >
                      {!isAdmin &&
                        (selectedEntry?.owner === userEmail ||
                          ...
                          <Button
                            ...
                            onClick={() =>
                              navigate(
                                `/publications-tracker/dashboard/entries/${selectedEntryId}/edit`,
                              )
                            }
                            sx={{
                              borderColor: "#D9E2EC",
                      ...
                      <Chip
                        ...
                        size="small"
                        sx={{
                          ...statusSx(selectedEntry?.status ?? "draft"),
                          fontWeight: 700,
                        }}
                      />
                    </Box>
                        ...
                        {selectedEntry.status === "draft" && (
                          <Button
                            ...
                            sx={{
                              ...
                              color: "#0077B6",
                              "&:hover": { bgcolor: "rgba(0,119,182,0.18)" },
                              borderRadius: "10px",
                              textTransform: "none",
                              fontWeight: 600,
                            }}
                          ...
                          isAdmin && (
                            <>
                              <Button
                                ...
                                sx={{
                                  bgcolor: "rgba(22,128,60,0.1)",
                                  color: "#16803C",
                                  "&:hover": {
                                    bgcolor: "rgba(22,128,60,0.18)",
                                  },
                                  borderRadius: "10px",
                                  textTransform: "none",
                                  fontWeight: 600,
                          ...
                          isAdmin && (
                            <Button
                              ...
                              sx={{
                                bgcolor: "rgba(22,128,60,0.1)",
                                color: "#16803C",
                                "&:hover": { bgcolor: "rgba(22,128,60,0.18)" },
                                borderRadius: "10px",
                                textTransform: "none",
                                fontWeight: 600,
                              }}
                  ...
                  <Grid size={{ xs: 12, lg: 7 }}>
                    <Stack spacing={3}>
                      ...
                      >
                        ...
                        <Typography
                          variant="body2"
                          sx={{ mt: 1.5, lineHeight: 1.75, color: "#1F2933" }}
                        >
                                ...
                                return (
                                  ...
                                  >
                                    <TimelineSeparator>
                                      <TimelineDot
                                        color={dotColor}
                                        sx={{ p: 0.75, boxShadow: 1 }}
                                      >
                                        {icon}
                                      </TimelineDot>
                                      {index <
                                        selectedEntry.timeline.length - 1 && (
                                        <TimelineConnector />
                                      )}
                                    </TimelineSeparator>
                                    <TimelineContent
                      ...
                      >
                        ...
                        <Stack
                          spacing={1}
                          sx={{ mt: 2, maxHeight: 256, overflowY: "auto" }}
                          className="thin-scroll"
                        >
                              ...
                              >
                                ...
                                >
                                  ...
                                  <Box sx={{ flex: 1 }}>
                                    <Typography
                                      variant="body2"
                                      sx={{ fontWeight: 500, color: "#1F2933" }}
                                    >
